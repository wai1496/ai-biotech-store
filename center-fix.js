...
(function(){
  ...
  function isSharedMasterImage(url,form){
    ...
    if(!s)return false;
    if(form==='Cartridge')return s.includes('/catalog-media/masters/cartridge-master');
